...
public class TextToRecipeTest {
    ...
    public void testParseJSON() {
        ...
        String responseText = """
                ...
                2. Add the diced chicken and cook until the chicken is cooked through, about
                8 minutes.
                ...
                6. Add in the cooked rice and soy sauce and stir to combine with the chicken
                and eggs.

                7. Cook the fried rice until everything is heated through, about 5 minutes.

                8. Drizzle with sesame oil, season with more salt and pepper if desired, and
                serve. Enjoy!
                """;
        String parsedResponse = """
                ...
                serve. Enjoy!
                """;
        Recipe recipe = textToRecipe.mapResponseToRecipe(responseText);
    ...
    public void testParseNoIndentsAndNewLines() {
        ...
        String responseText = """
                ...
                4. Add the onion and garlic and cook until lightly browned and fragrant,
                about 3 minutes.
                5. Add the ground beef and cook until browned and crumbled, about 5-8
                minutes.
                6. Add the tomatoes, oregano, basil, and red pepper flakes and season with
                salt and pepper to taste. Simmer the mixture for 8-10 minutes, or until the
                flavors have developed.
                7. In a greased 9x13 inch baking dish, combine the cooked pasta and beef
                mixture.
                8. Top with shredded cheese and bake in preheated oven for 25-30 minutes, or
